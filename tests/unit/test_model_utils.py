...
class TestModelUtilsUnit:
    ...
    def test_setup_flash_attention(self):
        ...
        with patch("src.model_utils.setup_flash_attention") as mock_setup:
            mock_setup.side_effect = lambda m, *a, **kw: setattr(m.config, '_attn_implementation', 'eager') or m
    ...
    def test_freeze_layers(self):
        ...
        model = freeze_layers(mock_model, "layer1")
    ...
    def test_unfreeze_layers(self):
        ...
        model = unfreeze_layers(mock_model, "layer1")
    ...
    def test_apply_lora_plus_scaling(self):
        ...
        model = apply_lora_plus_scaling(mock_model, scale=1.0, lr_ratio=2.0)
